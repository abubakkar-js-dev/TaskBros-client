...
const Hero = () => {
  return (
    <div className="section-wrap">
     <section className="relative bg-[url(https://images.unsplash.com/photo-1604014237800-1c9102c219da?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=88)] bg-cover bg-center bg-no-repeat">
