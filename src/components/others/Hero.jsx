...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    image.src = "https://i.ibb.co.com/cvxsbbg/photo-1604014237800-1c9102c219da-ixlib-rb-1-2.jpg";
  ...
  return (
    <div className="section-wrap">
      <section className="relative bg-[url(https://i.ibb.co.com/cvxsbbg/photo-1604014237800-1c9102c219da-ixlib-rb-1-2.jpg)] bg-cover bg-center bg-no-repeat">
