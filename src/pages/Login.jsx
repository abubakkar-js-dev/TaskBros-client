            ...
            <div className="w-full max-w-sm rounded bg-white p-6 sm:p-8 shadow-lg">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="nui_email" className="block text-gray-700 font-medium">
                            Email
                        </label>
                    ...
                    <input type="submit" className="btn w-full  font-medium hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400" value="Login" />
