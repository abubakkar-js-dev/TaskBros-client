...
const ServicesToDo = () => {
  ...
  return (
<div className={`mt-16 lg:mt-20 container mx-auto section-wrap ${theme === 'dark' ? 'bg-gray-900 text-white' : ''}`}>
  <Helmet>
  ...
  <div className="mb-16 text-center">
    <h4 className="flex items-center justify-center gap-3 mb-2">
      <span className={`border-t-2 w-10 ${theme === 'dark' ? 'border-gray-700' : 'border-gray-300'}`}></span>
      <span
              ...
              >
                <select
                  ...
                  className={`border rounded px-2 py-1 ${
                    theme === 'dark' ? 'border-gray-700 bg-gray-800 text-gray-300' : 'border-gray-300'
                  }`}
                  onChange={(e) =>
