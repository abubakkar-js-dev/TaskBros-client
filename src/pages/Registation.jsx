      ...
      <div className="flex items-center justify-center h-screen bg-gray-100 ">
        <div className="max-w-md space-y-6 rounded-lg border bg-white p-10 shadow-lg ">
          <div className="flex flex-col space-y-1">
            <h3 className="text-3xl font-bold tracking-tight text-gray-800">Sign Up</h3>
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <input type="submit" className="btn transition-colors hover:bg-blue-600 focus:ring-2 focus:ring-blue-400 " value="Register" />
